...
extern void build_network(data *dptr, params *pptr, connect *cptr);
...
extern void set_visring_weights(params *pptr, data *dptr, connect *cptr);

extern void free_memory(params *pptr, data *dptr, connect *cptr);
