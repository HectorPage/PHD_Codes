...
extern void build_network(data *dptr, params *pptr, connect *cptr, cArray **bptr, cArray **bxptr);
...
extern void free_memory(params *pptr, data *dptr, connect *cptr, cArray **bptr, cArray **bxptr);
